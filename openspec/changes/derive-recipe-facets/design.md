...
- **Agreement threshold** for declaring a Tier-B field "trusted as default" — set numerically after the eval (and decide whether any field's rate is low enough to keep it authored-required instead).
