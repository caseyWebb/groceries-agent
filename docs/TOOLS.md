...
- `relist_grocery_send_line(send_id, line_key, expected_row_version)` performs guarded `in_cart → active`, clears linkage, retains immutable history, and writes no spend.
