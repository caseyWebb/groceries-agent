...
### `propose_meal_plan(meals?, attendance?, nights?, seed?, lock?, exclude?, boost_ingredients?, nudges?, slots?, ephemeral_vibes?)`
...
### `display_meal_plan(meals?, attendance?, nights?, seed?, lock?, exclude?, boost_ingredients?, nudges?, slots?, ephemeral_vibes?)`
