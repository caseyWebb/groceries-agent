...
export const SEED = {
  ...
  app: {
    ...
    waste: {
      ...
      weekly: {
        "4w": [
          { events: 0, status: "empty", amount: 0 },
          { events: 1, status: "complete", amount: 14 },
          { events: 1, status: "complete", amount: 18 },
          { events: 1, status: "complete", amount: 110 },
        ],
        "8w": [
          { events: 0, status: "empty", amount: 0 },
          { events: 1, status: "complete", amount: 10 },
          { events: 1, status: "complete", amount: 16 },
          { events: 1, status: "complete", amount: 22 },
          { events: 0, status: "empty", amount: 0 },
          { events: 1, status: "complete", amount: 14 },
          { events: 1, status: "complete", amount: 18 },
          { events: 1, status: "complete", amount: 110 },
        ...
        "12w": [
          { events: 0, status: "empty", amount: 0 },
          { events: 1, status: "complete", amount: 30 },
          { events: 0, status: "empty", amount: 0 },
          { events: 0, status: "empty", amount: 0 },
          { events: 0, status: "empty", amount: 0 },
          { events: 1, status: "complete", amount: 10 },
