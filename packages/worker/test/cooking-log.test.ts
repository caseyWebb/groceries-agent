...
describe("validateNewEntry", () => {
  ...
  it("rejects the retired ready_to_eat type — log_cooked (cooking-write.ts) rejects it with no conversion, so an entry reaching here still carrying it is just another invalid type", () => {
