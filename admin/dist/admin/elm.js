...
{
	if (region.k.a$ === region.i.a$)
	{
		return 'on line ' + region.k.a$;
	}
	return 'on lines ' + region.k.a$ + ' through ' + region.i.a$;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var value = result.a;
		var message = !tag ? value : tag < 3 ? value.a : value.b2;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ev: 'hidden', ei: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ev: 'mozHidden', ei: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ev: 'msHidden', ei: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ev: 'webkitHidden', ei: 'webkitvisibilitychange' }
		: { ev: 'hidden', ei: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.fg) && _Http_track(router, xhr, request.fg.a);

		try {
			xhr.open(request.eH, request.bI, true);
		} catch (e) {
...
{
	for (var headers = request.eu; headers.b; headers = headers.b) // WHILE_CONS
	{
		xhr.setRequestHeader(headers.a.a, headers.a.b);
	}
	xhr.timeout = request.fe.a || 0;
	xhr.responseType = request.bm.d;
	xhr.withCredentials = request.eb;
}
...
function _Http_toMetadata(xhr)
{
	return {
		...
		e9: xhr.status,
		fa: xhr.statusText,
		eu: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{v: nodeList, r: (len / $elm$core$Array$branchFactor) | 0, s: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {c_: fragment, c6: host, cb: path, du: port_, dy: protocol, dz: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {aA: frag, aC: params, aw: unvisited, d3: value, aH: visited};
	});
var $elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _v1 = state.aw;
			if (!_v1.b) {
				return $elm$core$Maybe$Just(state.d3);
			} else {
				if ((_v1.a === '') && (!_v1.b.b)) {
					return $elm$core$Maybe$Just(state.d3);
				} else {
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.e9));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{eb: false, bM: r.bM, bm: r.bm, eu: r.eu, eH: r.eH, fe: r.fe, fg: r.fg, bI: r.bI}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bM: $elm$http$Http$emptyBody, bm: r.bm, eu: _List_Nil, eH: 'GET', fe: $elm$core$Maybe$Nothing, fg: $elm$core$Maybe$Nothing, bI: r.bI});
};
...
var $author$project$Config$CalibrationS = function (a) {
	return {$: 0, a: a};
};
var $author$project$Config$EditorMsg = function (a) {
	return {$: 3, a: a};
};
var $author$project$Config$EditorS = function (a) {
	return {$: 3, a: a};
};
var $author$project$Config$FlyerMsg = function (a) {
	return {$: 2, a: a};
};
var $author$project$Config$FlyerS = function (a) {
	return {$: 2, a: a};
};
var $author$project$Config$RankingMsg = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$RankingS = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$TableEditor$Text = 0;
var $author$project$Config$aliasesConfig = {
	aV: _List_fromArray(
		[
			{X: 'variant', Y: 0, Z: 'Variant', ab: true},
			{X: 'canonical', Y: 0, Z: 'Canonical', ab: true}
		]),
	a5: 'variant',
	a8: 'aliases',
	bb: $elm$core$Maybe$Nothing,
	bd: 'Ingredient aliases'
};
var $author$project$Config$TableEditor$Number = 1;
var $author$project$Config$TableEditor$Tags = 2;
var $author$project$Config$feedsConfig = {
	aV: _List_fromArray(
		[
			{X: 'url', Y: 0, Z: 'URL', ab: true},
			{X: 'name', Y: 0, Z: 'Name', ab: false},
			{X: 'weight', Y: 1, Z: 'Weight', ab: false},
			{X: 'tags', Y: 2, Z: 'Tags', ab: false}
		]),
	a5: 'url',
	a8: 'feeds',
...
var $author$project$Config$flyerTermsConfig = {
	aV: _List_fromArray(
		[
			{X: 'term', Y: 0, Z: 'Term', ab: true}
		]),
	a5: 'term',
	a8: 'flyer-terms',
	bb: $elm$core$Maybe$Nothing,
...
var $author$project$Config$Calibration$Clean = {$: 0};
var $krisajenkins$remotedata$RemoteData$NotAsked = {$: 0};
var $author$project$Config$Calibration$GotConfig = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Config$Calibration$configDecoder = A2(
	...
	function (c) {
		return A5(
			...
			A2($elm$json$Json$Decode$field, 'fetchMaxPerTick', $elm$json$Json$Decode$int),
			A2($elm$json$Json$Decode$field, 'maxCandidatesPerTick', $elm$json$Json$Decode$int),
			A2($elm$json$Json$Decode$field, 'retryMaxAttempts', $elm$json$Json$Decode$int),
			A2($elm$json$Json$Decode$field, 'logRetentionDays', $elm$json$Json$Decode$int));
	},
	A6(
		$elm$json$Json$Decode$map5,
		F5(
			function (tau, triage, delta, cap, rate) {
				return {M: cap, O: delta, C: 0, D: 0, E: 0, R: rate, F: 0, S: tau, T: triage};
			}),
...
var $author$project$Config$Flyer$Clean = {$: 0};
var $author$project$Config$Flyer$GotConfig = function (a) {
	return {$: 0, a: a};
};
var $author$project$Config$Flyer$Config = F3(
	function (minFlyerDiscount, flyerRefreshHours, flyerBatchUnits) {
		return {ak: flyerBatchUnits, al: flyerRefreshHours, b4: minFlyerDiscount};
	});
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Config$Flyer$configDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Config$Flyer$Config,
	A2($elm$json$Json$Decode$field, 'minFlyerDiscount', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'flyerRefreshHours', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'flyerBatchUnits', $elm$json$Json$Decode$int));
...
var $author$project$Config$Flyer$init = _Utils_Tuple2(
	...
	$author$project$Config$Flyer$fetchConfig);
var $author$project$Config$Ranking$Clean = {$: 0};
var $author$project$Config$Ranking$GotConfig = function (a) {
	return {$: 0, a: a};
};
var $author$project$Config$Ranking$Config = F6(
	function (favoriteWeight, noveltyBoost, pantryWeight, perishWeight, keyWeight, overlapCap) {
		return {aj: favoriteWeight, am: keyWeight, ao: noveltyBoost, aq: overlapCap, ar: pantryWeight, as: perishWeight};
	});
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Config$Ranking$configDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Config$Ranking$Config,
	A2($elm$json$Json$Decode$field, 'favoriteWeight', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'noveltyBoost', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'pantryWeight', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'perishWeight', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'keyWeight', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'overlapCap', $elm$json$Json$Decode$int));
...
var $author$project$Config$Ranking$init = _Utils_Tuple2(
	...
	$author$project$Config$Ranking$fetchConfig);
...
var $author$project$Config$TableEditor$corpusUrl = F2(
	function (slug, extra) {
		return A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						'corpus',
						A2($elm$core$List$cons, slug, extra)))),
			_List_Nil);
	});
var $author$project$Data$Table$TablePage = F3(
	function (table, columns, rows) {
		return {cE: columns, av: rows, fc: table};
	});
	...
	return $elm$http$Http$get(
		{
			...
			bI: A2($author$project$Config$TableEditor$corpusUrl, config.a8, _List_Nil)
		});
};
var $author$project$Config$TableEditor$init = function (config) {
	return _Utils_Tuple2(
		{y: $author$project$Config$TableEditor$Idle, N: config, ae: $elm$core$Dict$empty, av: $krisajenkins$remotedata$RemoteData$Loading, aE: $elm$core$Maybe$Nothing},
		$author$project$Config$TableEditor$fetchRows(config));
};
var $author$project$Config$membersConfig = {
	aV: _List_fromArray(
		[
			{X: 'address', Y: 0, Z: 'Address', ab: true}
		]),
	a5: 'address',
	a8: 'members',
	bb: $elm$core$Maybe$Nothing,
	bd: 'Discovery members'
};
var $author$project$Config$sendersConfig = {
	aV: _List_fromArray(
		[
			{X: 'address', Y: 0, Z: 'Address', ab: true},
			{X: 'name', Y: 0, Z: 'Name', ab: false}
	...
	a8: 'senders',
	bb: $elm$core$Maybe$Nothing,
	bd: 'Newsletter senders'
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Config$wrap = F4(
	function (toSection, toMsg, configRoute, _v0) {
		var sub = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			{
...
var $author$project$Config$init = function (configRoute) {
	switch (configRoute) {
		case 0:
			return A4($author$project$Config$wrap, $author$project$Config$CalibrationS, $author$project$Config$CalibrationMsg, configRoute, $author$project$Config$Calibration$init);
		case 1:
			return A4($author$project$Config$wrap, $author$project$Config$RankingS, $author$project$Config$RankingMsg, configRoute, $author$project$Config$Ranking$init);
		case 2:
			return A4($author$project$Config$wrap, $author$project$Config$FlyerS, $author$project$Config$FlyerMsg, configRoute, $author$project$Config$Flyer$init);
		case 3:
			return A4(
				$author$project$Config$wrap,
				$author$project$Config$EditorS,
				$author$project$Config$EditorMsg,
				configRoute,
				$author$project$Config$TableEditor$init($author$project$Config$aliasesConfig));
		case 4:
			return A4(
				$author$project$Config$wrap,
				$author$project$Config$EditorS,
				$author$project$Config$EditorMsg,
				configRoute,
				$author$project$Config$TableEditor$init($author$project$Config$flyerTermsConfig));
		case 5:
			return A4(
				$author$project$Config$wrap,
				$author$project$Config$EditorS,
				$author$project$Config$EditorMsg,
				configRoute,
				$author$project$Config$TableEditor$init($author$project$Config$feedsConfig));
		case 6:
			return A4(
				$author$project$Config$wrap,
				$author$project$Config$EditorS,
				$author$project$Config$EditorMsg,
				configRoute,
				$author$project$Config$TableEditor$init($author$project$Config$sendersConfig));
		default:
			return A4(
				$author$project$Config$wrap,
				$author$project$Config$EditorS,
				$author$project$Config$EditorMsg,
				configRoute,
				$author$project$Config$TableEditor$init($author$project$Config$membersConfig));
	}
};
...
var $author$project$Data$Corpus$Listing = F2(
	function (prefix, entries) {
		return {cU: entries, a6: prefix};
	});
var $author$project$Data$Corpus$Entry = F2(
	function (name, kind) {
		return {Y: kind, bt: name};
	});
...
var $author$project$Data$Table$init = F2(
	function (group, tables) {
		...
		if (!_v0.$) {
			var first = _v0.a;
			return _Utils_Tuple2(
				{aT: first, bp: group, aO: $krisajenkins$remotedata$RemoteData$Loading, a9: tables},
				A2($author$project$Data$Table$fetch, group, first));
		} else {
			return _Utils_Tuple2(
				{aT: '', bp: group, aO: $krisajenkins$remotedata$RemoteData$NotAsked, a9: tables},
...
var $author$project$Data$Corpus$init = function () {
	...
	var tablesCmd = _v0.b;
	return _Utils_Tuple2(
		{a0: $krisajenkins$remotedata$RemoteData$Loading, ap: $elm$core$Maybe$Nothing, a6: $author$project$Data$Corpus$guidanceRoot, a9: tables},
	...
	A9(
		...
		F8(
			function (id, profile, pantry, mealPlan, groceryList, overlay, cookingLog, recipeNotes) {
				return {bP: cookingLog, bX: groceryList, aL: id, b0: mealPlan, b8: overlay, b9: pantry, cd: profile, ce: recipeNotes, bC: _List_Nil};
			}),
...
var $author$project$Data$Member$selectionFor = $elm$core$Maybe$map(
	function (id) {
		return {bl: $krisajenkins$remotedata$RemoteData$Loading, aL: id};
	});
var $author$project$Data$Member$init = function (selectedId) {
	return _Utils_Tuple2(
		{
			aN: $krisajenkins$remotedata$RemoteData$Loading,
			aP: $author$project$Data$Member$selectionFor(selectedId)
		},
		$elm$core$Platform$Cmd$batch(
			A2(
				$elm$core$List$cons,
...
var $author$project$Data$Recipe$RecipeDetail = F9(
	function (slug, tier, source, projection, description, hasEmbedding, dispositions, notes, body) {
		return {bM: body, cO: description, cR: dispositions, c3: hasEmbedding, dq: notes, dx: projection, a8: slug, dR: source, d$: tier};
	});
...
var $author$project$Data$Recipe$Disposition = F3(
	function (tenant, favorite, reject) {
		return {cX: favorite, dC: reject, d_: tenant};
	});
...
var $author$project$Data$Recipe$recipeDetailDecoder = A3(
	$elm$json$Json$Decode$map2,
	F2(
	...
	return $elm$http$Http$get(
		{
			...
			bI: '/admin/api/data/recipes/' + slug
		});
};
...
var $author$project$Data$Recipe$ListEntry = F3(
	function (slug, title, status) {
		return {a8: slug, bB: status, bd: title};
	});
...
var $author$project$Data$Recipe$fetchList = $elm$http$Http$get(
	{
		...
		bI: '/admin/api/data/recipes'
	});
var $author$project$Data$Recipe$selectionFor = function (selectedSlug) {
	return A2(
		$elm$core$Maybe$map,
		function (slug) {
			return {bl: $krisajenkins$remotedata$RemoteData$Loading, a8: slug};
		},
		selectedSlug);
};
...
var $author$project$Dev$ToolConsole$Tool = F3(
	function (name, description, schema) {
		return {cO: description, bt: name, a7: schema};
	});
	...
	return $elm$http$Http$get(
		{
			...
			bI: '/admin/api/tools?tenant=' + $elm$url$Url$percentEncode(persona)
		});
};
...
var $author$project$Dev$ToolConsole$freshSession = F3(
	function (members, persona, tool) {
		return {
			aY: $author$project$Dev$ToolConsole$Pristine,
			aI: $krisajenkins$remotedata$RemoteData$Loading,
			aN: members,
			at: persona,
			ac: $author$project$Dev$ToolConsole$Ready($krisajenkins$remotedata$RemoteData$NotAsked),
			aP: tool
		};
	});
...
var $author$project$Logs$Entry = F8(
	function (id, url, title, source, outcome, slug, detail, createdAt) {
		return {bQ: createdAt, bl: detail, aL: id, bu: outcome, a8: slug, dR: source, bd: title, bI: url};
	});
...
var $author$project$Logs$Failed = {$: 6};
...
var $author$project$Logs$outcomeFromString = function (raw) {
	switch (raw) {
		...
		case 'failed':
			return $author$project$Logs$Failed;
		default:
...
var $author$project$Logs$load = F2(
	function (source, _v0) {
		var model = _v0.a;
		var cmd = _v0.b;
		return ($krisajenkins$remotedata$RemoteData$isLoading(model.H) || $krisajenkins$remotedata$RemoteData$isSuccess(model.H)) ? _Utils_Tuple2(model, cmd) : _Utils_Tuple2(
			_Utils_update(
				model,
...
var $author$project$Logs$init = function (source) {
	return A2(
		...
		source,
		_Utils_Tuple2(
			{H: $krisajenkins$remotedata$RemoteData$NotAsked, W: $elm$core$Maybe$Nothing, aP: source},
			$elm$core$Platform$Cmd$none));
};
...
var $author$project$Status$HealthPayload = F6(
	function (ok, generatedAt, jobs, d1Ok, admin, aiQuotaExhausted) {
		return {bK: admin, cu: aiQuotaExhausted, cI: d1Ok, c$: generatedAt, df: jobs, ds: ok};
	});
var $author$project$Status$AdminPosture = F4(
	function (accessConfigured, emailAllowlist, devBypassSet, exposed) {
		return {cs: accessConfigured, cQ: devBypassSet, cT: emailAllowlist, bV: exposed};
	});
...
var $author$project$Status$Job = F4(
	function (name, state, lastRunAt, summary) {
		return {di: lastRunAt, bt: name, dU: state, dY: summary};
	});
...
var $author$project$Status$healthDecoder = A7(
	$elm$json$Json$Decode$map6,
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'ai_quota_exhausted', $elm$json$Json$Decode$bool),
...
var $author$project$Status$fetchHealth = $elm$http$Http$get(
	{
		bm: $author$project$Status$expectHealth(
...
var $author$project$Status$init = _Utils_Tuple2(
	{a_: $krisajenkins$remotedata$RemoteData$Loading, bJ: $elm$time$Time$utc},
	$elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
		...
		switch (route.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$HealthPage(subModel),
							ag: route
						}),
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$MembersPage(subModel),
							ag: route
						}),
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$ToolsPage(subModel),
							ag: route
						}),
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$LogsPage(subModel),
							ag: route
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$LogsMsg, cmd));
			case 4:
				var configRoute = route.a;
				var _v5 = $author$project$Config$init(configRoute);
				var subModel = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$ConfigPage(subModel),
							ag: route
						}),
			...
			case 5:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aO: $author$project$Main$DataPage(subModel),
							ag: route
						}),
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aO: $author$project$Main$NotFoundPage, ag: route}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Route$Config = function (a) {
	return {$: 4, a: a};
};
var $author$project$Route$ConfigCalibration = 0;
...
var $author$project$Route$ConfigAliases = 3;
var $author$project$Route$ConfigFeeds = 5;
var $author$project$Route$ConfigFlyer = 2;
var $author$project$Route$ConfigFlyerTerms = 4;
var $author$project$Route$ConfigMembers = 7;
var $author$project$Route$ConfigRanking = 1;
var $author$project$Route$ConfigSenders = 6;
var $author$project$Route$configRouteFromSlug = function (slug) {
	switch (slug) {
		case 'ranking':
...
var $author$project$Route$configRoute = A2($elm$url$Url$Parser$custom, 'CONFIG_ROUTE', $author$project$Route$configRouteFromSlug);
		...
		[
			...
			A2(
				...
				A2(
					$elm$url$Url$Parser$slash,
					$elm$url$Url$Parser$s('config'),
					$author$project$Route$configRoute))),
			A2(
			$elm$url$Url$Parser$map,
	...
	return A2(
		...
		A2(
			...
			_Utils_update(
				url,
				{
					cb: $author$project$Route$stripTrailingSlash(url.cb)
				})));
};
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return A3(
			...
			{bg: $author$project$Main$defaultDevSection, X: key, aO: $author$project$Main$NotFoundPage, ag: $author$project$Route$NotFound});
	});
...
var $author$project$Main$scrollToSection = function (section) {
	return A2(
		...
		A2(
			$elm$core$Task$andThen,
			function (el) {
				return A2($elm$browser$Browser$Dom$setViewport, 0, el.en.fk - $author$project$Main$subnavHeight);
			},
			$elm$browser$Browser$Dom$getElement(
				$author$project$Main$sectionId(section))));
};
var $author$project$Config$goto = F2(
	function (configRoute, model) {
		return _Utils_eq(configRoute, model.ag) ? _Utils_Tuple2(
			_Utils_update(
				model,
				{ag: configRoute}),
			$elm$core$Platform$Cmd$none) : $author$project$Config$init(configRoute);
	});
...
var $author$project$Data$goto = F2(
	function (dataRoute, model) {
		var _v0 = _Utils_Tuple2(dataRoute, model.bA);
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 0:
	...
	function (source, model) {
		return A2(
			...
			_Utils_Tuple2(
				_Utils_update(
					model,
					{W: $elm$core$Maybe$Nothing, aP: source}),
				$elm$core$Platform$Cmd$none));
	});
...
var $author$project$Main$stepTo = F2(
	function (route, model) {
		var _v0 = _Utils_Tuple2(route, model.aO);
		_v0$6:
		while (true) {
			switch (_v0.a.$) {
				case 2:
					if (_v0.b.$ === 2) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									aO: $author$project$Main$ToolsPage(subModel2),
									ag: route
								}),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$ToolsMsg, cmd));
					} else {
					...
					if (_v0.b.$ === 3) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									aO: $author$project$Main$LogsPage(subModel2),
									ag: route
								}),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$LogsMsg, cmd));
					} else {
				...
				case 4:
					if (_v0.b.$ === 4) {
						var configRoute = _v0.a.a;
						var subModel = _v0.b.a;
						var _v5 = A2($author$project$Config$goto, configRoute, subModel);
						var subModel2 = _v5.a;
						var cmd = _v5.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									aO: $author$project$Main$ConfigPage(subModel2),
									ag: route
								}),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$ConfigMsg, cmd));
					} else {
					...
					if (_v0.b.$ === 5) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									aO: $author$project$Main$DataPage(subModel2),
									ag: route
								}),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$DataMsg, cmd));
					} else {
...
var $author$project$Admin$Members$clearBannerFor = F2(
	function (username, banner) {
		if (!banner.$) {
			...
			return _Utils_eq(credentials.cr, username) ? $elm$core$Maybe$Nothing : banner;
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Admin$Members$Credentials = F3(
	function (username, inviteCode, connectorUrl) {
		return {cF: connectorUrl, db: inviteCode, cr: username};
	});
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{bM: r.bM, bm: r.bm, eu: _List_Nil, eH: 'POST', fe: $elm$core$Maybe$Nothing, fg: $elm$core$Maybe$Nothing, bI: r.bI});
};
		...
		return $elm$http$Http$post(
			{
				...
				bm: A2($elm$http$Http$expectJson, $author$project$Admin$Members$OnboardResult, $author$project$Admin$Members$credentialsDecoder),
				bI: '/admin/api/tenants'
			});
	});
	...
	return $elm$http$Http$post(
		{
			...
			bI: '/admin/api/tenants/' + ($elm$url$Url$percentEncode(username) + '/rotate')
		});
};
var $author$project$Admin$Members$start = F3(
	function (model, operation, cmd) {
		return $author$project$Admin$Members$isBusy(model.y) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
			_Utils_update(
				model,
				{
					y: $author$project$Admin$Members$Busy(operation)
				}),
			cmd);
	});
		...
		switch (msg.$) {
			...
			case 3:
				var _v1 = _Utils_Tuple2(
					$author$project$Admin$Members$isBusy(model.y),
					...
					if (_v1.b === '') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									y: $author$project$Admin$Members$Busy($author$project$Admin$Members$Onboard)
								}),
							A2(
								$author$project$Admin$Members$onboard,
								username,
								$elm$core$String$trim(model.aM)));
					}
				}
			case 4:
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								ai: $elm$core$Maybe$Just(credentials),
								aM: '',
								aG: ''
							}),
						$author$project$Admin$Members$fetchMembers);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								y: A2($author$project$Admin$Members$Failed, $author$project$Admin$Members$Onboard, error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 5:
				...
				if (!msg.b.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								y: $author$project$Admin$Members$Idle,
								ai: A2($author$project$Admin$Members$clearBannerFor, username, model.ai),
								aN: A2(
...
var $author$project$Config$Calibration$Dirty = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$Calibration$NeedsConfirm = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Config$Calibration$configToDraft = function (c) {
	return {
		M: $elm$core$String$fromInt(c.M),
		O: $elm$core$String$fromFloat(c.O),
		C: $elm$core$String$fromInt(c.C),
		D: $elm$core$String$fromInt(c.D),
		E: $elm$core$String$fromInt(c.E),
		R: $elm$core$String$fromInt(c.R),
		F: $elm$core$String$fromInt(c.F),
		S: $elm$core$String$fromFloat(c.S),
		T: $elm$core$String$fromFloat(c.T)
	};
};
var $author$project$Config$Calibration$defaultConfig = {M: 12, O: 0.9, C: 5, D: 60, E: 40, R: 10, F: 3, S: 0.55, T: 0.45};
...
var $author$project$Config$Calibration$currentDraft = function (model) {
	var _v0 = model.t;
	switch (_v0.$) {
		case 0:
			return $author$project$Config$Calibration$configToDraft(
				A2($krisajenkins$remotedata$RemoteData$withDefault, $author$project$Config$Calibration$defaultConfig, model.ah));
		case 1:
			var d = _v0.a;
			return d;
		default:
...
var $author$project$Config$Calibration$extractFloorWarning = function (err) {
	if (err.$ === 3) {
		return $elm$core$Maybe$Just(
			{cY: 'unknown', b2: 'A value is below the safe floor. Confirm to override.'});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Config$Calibration$parseDraft = function (d) {
	return A2(
		$elm$core$Maybe$andThen,
		function (c) {
			return A5(
				...
				A2(
					$elm$core$Maybe$map,
					$elm$core$Basics$round,
					$elm$core$String$toFloat(d.E)),
				A2(
					$elm$core$Maybe$map,
					$elm$core$Basics$round,
					$elm$core$String$toFloat(d.F)),
				A2(
					$elm$core$Maybe$map,
					$elm$core$Basics$round,
		...
		A6(
			...
			F5(
				function (tau, triage, delta, cap, rate) {
					return {
						M: $elm$core$Basics$round(cap),
						O: delta,
						C: 0,
						D: 0,
						E: 0,
						R: $elm$core$Basics$round(rate),
						F: 0,
						S: tau,
						T: triage
					};
				}),
			$elm$core$String$toFloat(d.S),
			$elm$core$String$toFloat(d.T),
			$elm$core$String$toFloat(d.O),
			$elm$core$String$toFloat(d.M),
			$elm$core$String$toFloat(d.R)));
};
var $author$project$Config$Calibration$GotAnalyze = function (a) {
	return {$: 3, a: a};
};
var $author$project$Config$Calibration$AnalyzeResult = F5(
	function (deltaPairCount, deltaTopPairs, deltaBounded, deltaCorpusSize, memberTau) {
		return {cL: deltaBounded, cM: deltaCorpusSize, cN: deltaPairCount, bS: deltaTopPairs, b1: memberTau};
	});
var $author$project$Config$Calibration$MemberTauResult = F3(
	function (tenant, matchCount, coldStart) {
		return {cD: coldStart, dk: matchCount, d_: tenant};
	});
var $author$project$Config$Calibration$memberTauDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Config$Calibration$MemberTauResult,
	A2($elm$json$Json$Decode$field, 'tenant', $elm$json$Json$Decode$string),
...
var $author$project$Config$Calibration$TopPair = F3(
	function (slugA, slugB, cosine) {
		return {cG: cosine, dO: slugA, dP: slugB};
	});
var $author$project$Config$Calibration$topPairDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Config$Calibration$TopPair,
...
var $author$project$Config$Calibration$analyzeDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Config$Calibration$AnalyzeResult,
	A2($elm$json$Json$Decode$field, 'deltaPairCount', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'deltaTopPairs',
		$elm$json$Json$Decode$list($author$project$Config$Calibration$topPairDecoder)),
	...
	A2(
		$elm$json$Json$Decode$field,
		'memberTau',
		$elm$json$Json$Decode$list($author$project$Config$Calibration$memberTauDecoder)));
var $elm$json$Json$Encode$float = _Json_wrap;
var $elm$json$Json$Encode$int = _Json_wrap;
var $author$project$Config$Calibration$encodeDraft = function (d) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
	...
	return $elm$http$Http$post(
		{
			...
			bI: '/admin/api/discovery/analyze'
		});
};
...
var $author$project$Config$Calibration$DryRunOutcome = F6(
	function (url, title, source, outcome, slug, wouldMatchMembers) {
		return {bu: outcome, a8: slug, dR: source, bd: title, bI: url, d7: wouldMatchMembers};
	});
var $author$project$Config$Calibration$dryRunOutcomeDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Config$Calibration$DryRunOutcome,
	...
	$elm$json$Json$Decode$maybe(
		A2(
			...
			'wouldMatchMembers',
			$elm$json$Json$Decode$list($elm$json$Json$Decode$string))));
var $author$project$Config$Calibration$dryRunDecoder = A2(
	$elm$json$Json$Decode$field,
	'outcomes',
	$elm$json$Json$Decode$list($author$project$Config$Calibration$dryRunOutcomeDecoder));
	...
	return $elm$http$Http$post(
		{
			...
			bI: '/admin/api/discovery/dry-run'
		});
};
...
var $author$project$Config$Calibration$encodeDraftWithConfirm = F2(
	function (d, confirm) {
		return $elm$json$Json$Encode$object(
			A2(
				$elm$core$List$filterMap,
...
var $author$project$Config$Calibration$putConfig = F2(
	function (d, confirm) {
		return $elm$http$Http$request(
			{
				bM: $elm$http$Http$jsonBody(
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{t: $author$project$Config$Calibration$Clean, ah: result}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var setter = msg.a;
				var val = msg.b;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							t: $author$project$Config$Calibration$Dirty(
								A2(setter, base, val))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{ax: $krisajenkins$remotedata$RemoteData$Loading}),
					$author$project$Config$Calibration$postAnalyze(
						$author$project$Config$Calibration$currentDraft(model)));
			case 3:
				var result = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{az: $krisajenkins$remotedata$RemoteData$Loading}),
					$author$project$Config$Calibration$postDryRun(
						$author$project$Config$Calibration$currentDraft(model)));
			case 5:
				var result = msg.a;
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 6:
				var _v2 = $author$project$Config$Calibration$parseDraft(
					$author$project$Config$Calibration$currentDraft(model));
				if (_v2.$ === 1) {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						model,
						A2(
							$author$project$Config$Calibration$putConfig,
							$author$project$Config$Calibration$currentDraft(model),
							false));
				}
			case 7:
				...
				if (_v3.$ === 2) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								t: $author$project$Config$Calibration$Dirty(d)
							}),
						A2($author$project$Config$Calibration$putConfig, d, true));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 8:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									ah: $krisajenkins$remotedata$RemoteData$Success(config)
								}),
							$elm$core$Platform$Cmd$none);
					case 2:
						var err = msg.a.a;
						var _v5 = _Utils_Tuple2(
							model.t,
							$author$project$Config$Calibration$extractFloorWarning(err));
						if (_v5.a.$ === 1) {
							if (!_v5.b.$) {
								var d = _v5.a.a;
								var warning = _v5.b.a;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											t: A2($author$project$Config$Calibration$NeedsConfirm, d, warning)
										}),
									$elm$core$Platform$Cmd$none);
							} else {
								var _v6 = _v5.b;
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											ah: $krisajenkins$remotedata$RemoteData$Failure(err)
										}),
									$elm$core$Platform$Cmd$none);
							}
						} else {
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{ax: $krisajenkins$remotedata$RemoteData$NotAsked, az: $krisajenkins$remotedata$RemoteData$NotAsked, t: $author$project$Config$Calibration$Clean}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Config$Flyer$Dirty = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$Flyer$configToDraft = function (c) {
	return {
		ak: $elm$core$String$fromInt(c.ak),
		al: $elm$core$String$fromInt(c.al),
		a2: $elm$core$String$fromFloat(c.b4 * 100)
	};
};
var $author$project$Config$Flyer$defaultConfig = {ak: 12, al: 24, b4: 0.05};
var $author$project$Config$Flyer$GotSave = function (a) {
	return {$: 3, a: a};
};
var $author$project$Config$Flyer$encodeDraft = function (d) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
				[
					...
					function (v) {
						return _Utils_Tuple2(
							'minFlyerDiscount',
							$elm$json$Json$Encode$float(v / 100));
					},
					$elm$core$String$toFloat(d.a2)),
					A2(
					$elm$core$Maybe$map,
					function (v) {
						return _Utils_Tuple2(
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{t: $author$project$Config$Flyer$Clean, ah: result}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var setter = msg.a;
				var val = msg.b;
				var base = function () {
					var _v1 = model.t;
					if (!_v1.$) {
						return $author$project$Config$Flyer$configToDraft(
							A2($krisajenkins$remotedata$RemoteData$withDefault, $author$project$Config$Flyer$defaultConfig, model.ah));
					} else {
						var d = _v1.a;
						return d;
					}
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							t: $author$project$Config$Flyer$Dirty(
								A2(setter, base, val))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				...
				if (!_v2.$) {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Config$Flyer$putConfig(d));
				}
			case 3:
				switch (msg.a.$) {
					case 3:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									t: $author$project$Config$Flyer$Clean,
									ah: $krisajenkins$remotedata$RemoteData$Success(config)
								}),
							$elm$core$Platform$Cmd$none);
					case 2:
...
var $author$project$Config$Ranking$Dirty = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$Ranking$configToDraft = function (c) {
	return {
		aj: $elm$core$String$fromFloat(c.aj),
		am: $elm$core$String$fromFloat(c.am),
		ao: $elm$core$String$fromFloat(c.ao),
		aq: $elm$core$String$fromInt(c.aq),
		ar: $elm$core$String$fromFloat(c.ar),
		as: $elm$core$String$fromFloat(c.as)
	};
};
var $author$project$Config$Ranking$defaultConfig = {aj: 0.15, am: 0.4, ao: 0.1, aq: 2, ar: 0.12, as: 1.0};
var $author$project$Config$Ranking$GotSave = function (a) {
	return {$: 3, a: a};
};
var $author$project$Config$Ranking$encodeDraft = function (d) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{t: $author$project$Config$Ranking$Clean, ah: result}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var setter = msg.a;
				var val = msg.b;
				var base = function () {
					var _v1 = model.t;
					if (!_v1.$) {
						return $author$project$Config$Ranking$configToDraft(
							A2($krisajenkins$remotedata$RemoteData$withDefault, $author$project$Config$Ranking$defaultConfig, model.ah));
					} else {
						var d = _v1.a;
						return d;
					}
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							t: $author$project$Config$Ranking$Dirty(
								A2(setter, base, val))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				...
				if (!_v2.$) {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Config$Ranking$putConfig(d));
				}
			case 3:
				switch (msg.a.$) {
					case 3:
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									t: $author$project$Config$Ranking$Clean,
									ah: $krisajenkins$remotedata$RemoteData$Success(config)
								}),
							$elm$core$Platform$Cmd$none);
					case 2:
...
var $author$project$Config$TableEditor$Add = {$: 0};
var $author$project$Config$TableEditor$Busy = function (a) {
	return {$: 1, a: a};
};
var $author$project$Config$TableEditor$Failed = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Config$TableEditor$Remove = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Config$TableEditor$draftValue = F2(
	function (draft, key) {
		return $elm$core$String$trim(
			A2(
				$elm$core$Maybe$withDefault,
				'',
				A2($elm$core$Dict$get, key, draft)));
	});
var $author$project$Config$TableEditor$canAdd = function (model) {
	return A2(
		$elm$core$List$all,
		function (f) {
			return (!f.ab) || (!$elm$core$String$isEmpty(
				A2($author$project$Config$TableEditor$draftValue, model.ae, f.X)));
		},
		model.N.aV);
};
var $author$project$Config$TableEditor$GotRemove = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var $author$project$Config$TableEditor$deleteRow = F2(
	function (config, key) {
		return $elm$http$Http$request(
			{
				bM: $elm$http$Http$emptyBody,
...
var $author$project$Config$TableEditor$isBusy = function (action) {
	if (action.$ === 1) {
		return true;
	} else {
		return false;
...
var $author$project$Config$TableEditor$GotAdd = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Config$TableEditor$splitTags = function (raw) {
	return A2(
		$elm$core$List$filter,
...
var $author$project$Config$TableEditor$encodeField = F2(
	function (draft, field) {
		var raw = A2($author$project$Config$TableEditor$draftValue, draft, field.X);
		return $elm$core$String$isEmpty(raw) ? (field.ab ? $elm$core$Maybe$Just(
			_Utils_Tuple2(
				field.X,
				$elm$json$Json$Encode$string(''))) : $elm$core$Maybe$Nothing) : $elm$core$Maybe$Just(
			_Utils_Tuple2(
				field.X,
				function () {
					var _v0 = field.Y;
						...
						case 1:
							return A2(
								...
								A2(
									...
									$elm$core$String$toFloat(raw)));
						default:
							return A2(
								$elm$json$Json$Encode$list,
								$elm$json$Json$Encode$string,
								$author$project$Config$TableEditor$splitTags(raw));
					}
				}()));
	});
var $author$project$Config$TableEditor$encodeAdd = F2(
	function (config, draft) {
		return $elm$json$Json$Encode$object(
			A2(
				$elm$core$List$filterMap,
				$author$project$Config$TableEditor$encodeField(draft),
				config.aV));
	});
var $author$project$Config$TableEditor$postAdd = F2(
	function (config, draft) {
		return $elm$http$Http$post(
			{
				bM: $elm$http$Http$jsonBody(
					A2($author$project$Config$TableEditor$encodeAdd, config, draft)),
				bm: $elm$http$Http$expectWhatever($author$project$Config$TableEditor$GotAdd),
				bI: A2($author$project$Config$TableEditor$corpusUrl, config.a8, _List_Nil)
			});
	});
...
var $author$project$Config$TableEditor$feedStatusDecoder = A5(
	...
	A2($elm$json$Json$Decode$field, 'parsed', $elm$json$Json$Decode$bool),
...
var $author$project$Config$TableEditor$SampleOutcome = F3(
	function (url, outcome, status) {
		return {bu: outcome, bB: status, bI: url};
	});
var $author$project$Config$TableEditor$sampleOutcomeDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Config$TableEditor$SampleOutcome,
	A2($elm$json$Json$Decode$field, 'url', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'outcome', $elm$json$Json$Decode$string),
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'status', $elm$json$Json$Decode$int)));
var $author$project$Config$TableEditor$feedVerdictDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Config$TableEditor$FeedVerdict,
	A2($elm$json$Json$Decode$field, 'feed', $author$project$Config$TableEditor$feedStatusDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'sample',
		$elm$json$Json$Decode$list($author$project$Config$TableEditor$sampleOutcomeDecoder)));
var $author$project$Config$TableEditor$postTest = F2(
	function (target, url) {
		return $elm$http$Http$post(
			{
				bM: $elm$http$Http$jsonBody(
...
var $author$project$Config$TableEditor$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var rows = msg.a;
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ae: A3($elm$core$Dict$insert, key, val, model.ae)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return ($author$project$Config$TableEditor$isBusy(model.y) || (!$author$project$Config$TableEditor$canAdd(model))) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							y: $author$project$Config$TableEditor$Busy($author$project$Config$TableEditor$Add)
						}),
					A2($author$project$Config$TableEditor$postAdd, model.N, model.ae));
			case 3:
				if (!msg.a.$) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{y: $author$project$Config$TableEditor$Idle, ae: $elm$core$Dict$empty, av: $krisajenkins$remotedata$RemoteData$Loading}),
						$author$project$Config$TableEditor$fetchRows(model.N));
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								y: A2($author$project$Config$TableEditor$Failed, $author$project$Config$TableEditor$Add, err)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 4:
				var key = msg.a;
				return $author$project$Config$TableEditor$isBusy(model.y) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							y: $author$project$Config$TableEditor$Busy(
								$author$project$Config$TableEditor$Remove(key))
						}),
					A2($author$project$Config$TableEditor$deleteRow, model.N, key));
			case 5:
				if (!msg.b.$) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{y: $author$project$Config$TableEditor$Idle, av: $krisajenkins$remotedata$RemoteData$Loading}),
						$author$project$Config$TableEditor$fetchRows(model.N));
				} else {
					var key = msg.a;
					var err = msg.b.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								y: A2(
									$author$project$Config$TableEditor$Failed,
									$author$project$Config$TableEditor$Remove(key),
									err)
							}),
						$elm$core$Platform$Cmd$none);
					...
					_Utils_update(
						model,
						{
							aE: $elm$core$Maybe$Just(
								_Utils_Tuple2(target, $krisajenkins$remotedata$RemoteData$Loading))
						}),
					A2($author$project$Config$TableEditor$postTest, target, url));
			default:
				var target = msg.a;
				var result = msg.b;
				return _Utils_Tuple2(
...
var $author$project$Config$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model.bA);
		switch (_v0.a.$) {
			case 0:
				if (!_v0.b.$) {
					var sub = _v0.a.a;
					...
					return A4(
						$author$project$Config$wrap,
						$author$project$Config$CalibrationS,
						$author$project$Config$CalibrationMsg,
						model.ag,
						A2($author$project$Config$Calibration$update, sub, m));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 1:
				if (_v0.b.$ === 1) {
					...
					return A4(
						$author$project$Config$wrap,
						$author$project$Config$RankingS,
						$author$project$Config$RankingMsg,
						model.ag,
						A2($author$project$Config$Ranking$update, sub, m));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 2:
				if (_v0.b.$ === 2) {
					...
					return A4(
						$author$project$Config$wrap,
						$author$project$Config$FlyerS,
						$author$project$Config$FlyerMsg,
						model.ag,
						A2($author$project$Config$Flyer$update, sub, m));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			default:
				if (_v0.b.$ === 3) {
					...
					return A4(
						...
						$author$project$Config$EditorMsg,
						model.ag,
						A2($author$project$Config$TableEditor$update, sub, m));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				...
				A2($author$project$Data$Table$fetch, model.bp, name));
		} else {
			var page = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Data$Corpus$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var sub = msg.a;
				var _v1 = A2($author$project$Data$Table$update, sub, model.a9);
				var tables = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{a0: $krisajenkins$remotedata$RemoteData$Loading, ap: $elm$core$Maybe$Nothing, a6: prefix}),
...
var $author$project$Data$Member$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			if (!_v1.$) {
				var selected = _v1.a;
				return _Utils_eq(selected.aL, id) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aP: $elm$core$Maybe$Just(
...
var $author$project$Data$Recipe$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			if (!_v1.$) {
				var selected = _v1.a;
				return _Utils_eq(selected.a8, slug) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aP: $elm$core$Maybe$Just(
...
var $author$project$Dev$SchemaExample$toField = F2(
	function (required, _v1) {
		...
		var value = _v1.b;
		return {
			bR: A2($author$project$Dev$SchemaExample$maybeField, 'default', value),
			cO: A2($author$project$Dev$SchemaExample$maybeStringField, 'description', value),
			bt: name,
			ab: A2($elm$core$List$member, name, required),
			a7: $author$project$Dev$SchemaExample$decodeSchema(value)
		};
	});
...
var $author$project$Dev$SchemaExample$hintComment = function (field) {
	var _v0 = $author$project$Dev$SchemaExample$enumOptions(field.a7);
	if (!_v0.$) {
		var options = _v0.a;
		return '  // ' + $author$project$Dev$SchemaExample$oneLine(
			A2($elm$core$String$join, ' | ', options));
	} else {
		if ($author$project$Dev$SchemaExample$isUnknown(field.a7)) {
...
var $author$project$Dev$SchemaExample$fieldValue = F3(
	function (level, commented, field) {
		...
		if (!_v4.$) {
			...
			return A3($author$project$Dev$SchemaExample$schemaValue, level, commented, field.a7);
		}
	});
...
var $author$project$Dev$SchemaExample$renderField = F3(
	function (level, inherit, field) {
		var commented = inherit || (!field.ab);
		var line = $author$project$Dev$SchemaExample$indent(level) + ('\"' + (field.bt + ('\": ' + (A3($author$project$Dev$SchemaExample$fieldValue, level, commented, field) + (',' + $author$project$Dev$SchemaExample$hintComment(field))))));
		...
		return $elm$http$Http$post(
			{
				...
				bm: A2($elm$http$Http$expectJson, $author$project$Dev$ToolConsole$gotInvocation, $author$project$Dev$ToolConsole$invocationDecoder),
				bI: '/admin/api/tools/' + $elm$url$Url$percentEncode(tool)
			});
	});
			...
			return _Utils_Tuple2(
				$author$project$Dev$ToolConsole$Acting(
					_Utils_update(
						session,
						{
							ac: $author$project$Dev$ToolConsole$Ready(
			...
			return _Utils_Tuple2(
				$author$project$Dev$ToolConsole$Acting(
					_Utils_update(
						session,
						{
							ac: $author$project$Dev$ToolConsole$Ready($krisajenkins$remotedata$RemoteData$Loading)
						})),
				A3($author$project$Dev$ToolConsole$invoke, session.at, tool, argsValue));
		}
	}
};
					...
					return _Utils_Tuple2(
						$author$project$Dev$ToolConsole$Acting(
							_Utils_update(
								session,
								{
									aN: A2($krisajenkins$remotedata$RemoteData$withDefault, session.aN, members)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
					...
					function (session) {
						return _Utils_Tuple2(
							_Utils_update(
								session,
								{
									aY: $author$project$Dev$ToolConsole$Edited(args)
								}),
							$elm$core$Platform$Cmd$none);
					});
			case 4:
				if (model.$ === 1) {
					var session = model.a;
					return $author$project$Dev$ToolConsole$needsConfirm(session.at) ? _Utils_Tuple2(
						$author$project$Dev$ToolConsole$Acting(
							_Utils_update(
								session,
								{ac: $author$project$Dev$ToolConsole$Confirming})),
					...
					function (session) {
						return _Utils_Tuple2(
							_Utils_update(
								session,
								{
									ac: $author$project$Dev$ToolConsole$Ready(result)
								}),
							$elm$core$Platform$Cmd$none);
					});
		}
...
var $author$project$Logs$Deleting = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Logs$Retrying = function (a) {
	return {$: 0, a: a};
};
var $author$project$Logs$RowFailed = F3(
	function (a, b, c) {
		return {$: 2, a: a, b: b, c: c};
	});
var $author$project$Logs$GotRowAction = F3(
	function (a, b, c) {
	...
	return $elm$http$Http$post(
		{
			...
			bI: '/admin/api/discovery/' + (id + '/retry')
		});
};
		...
		switch (msg.$) {
			...
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{H: $krisajenkins$remotedata$RemoteData$Loading, W: $elm$core$Maybe$Nothing}),
					...
					_Utils_update(
						model,
						{
							W: $elm$core$Maybe$Just(
								$author$project$Logs$Retrying(id))
						}),
					$author$project$Logs$postRetry(id));
			case 5:
				var id = msg.a;
				var _v4 = model.W;
				_v4$2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							W: $elm$core$Maybe$Just(
								$author$project$Logs$Deleting(id))
						}),
					$author$project$Logs$deleteRow(id));
			default:
				if (!msg.c.$) {
					var id = msg.a;
					var kind = msg.b;
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								W: $elm$core$Maybe$Just(
									A3($author$project$Logs$RowFailed, id, kind, err))
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
		...
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{a_: $krisajenkins$remotedata$RemoteData$Loading}),
					$author$project$Status$fetchHealth);
		}
	});
				...
				if (!_v0.b.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aO: $author$project$Main$HealthPage(subModel2)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$HealthMsg, cmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				...
				if (_v0.b.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aO: $author$project$Main$MembersPage(subModel2)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$MembersMsg, cmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Route$configSlug = function (configRoute_) {
	switch (configRoute_) {
		case 0:
			return '';
		case 1:
...
var $author$project$Route$configSegments = function (configRoute_) {
	if (!configRoute_) {
		return _List_Nil;
	} else {
		return _List_fromArray(
			[
				$author$project$Route$configSlug(configRoute_)
			]);
	}
};
			...
			return A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						'config',
						$author$project$Route$configSegments(configRoute_))),
				_List_Nil);
		case 5:
			var dataRoute = route.a;
			return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Invite for ' + credentials.cr)
								])),
							A2(
					...
					A2($author$project$Admin$Members$credentialRow, 'Invite code', credentials.db),
					A2($author$project$Admin$Members$credentialRow, 'Connector URL', credentials.cF)
				]));
	} else {
		return $elm$html$Html$text('');
	}
							...
							return A2(
								...
								_List_fromArray(
									[
										...
										A2(
											$elm$core$List$map,
											$author$project$Admin$Members$viewMember(model.y),
											members))
									]));
						}
				}
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$disabled(
						submitting || ($elm$core$String$trim(model.aG) === ''))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Admin$Members$viewBanner(model.ai),
				$author$project$Admin$Members$viewOnboard(model),
				$author$project$Admin$Members$viewMembers(model)
			]));
};
var $author$project$Config$Calibration$CancelConfirm = {$: 8};
var $author$project$Config$Calibration$ConfirmSave = {$: 7};
var $author$project$Config$Calibration$viewConfirmBanner = function (model) {
	var _v0 = model.t;
	if (_v0.$ === 2) {
		var warning = _v0.b;
		return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Config$Calibration$ConfirmSave)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Config$Calibration$CancelConfirm)
						]),
					_List_fromArray(
						[
...
var $author$project$Config$Calibration$RunAnalyze = {$: 2};
var $author$project$Config$Calibration$RunDryRun = {$: 4};
var $author$project$Config$Calibration$SaveConfig = {$: 6};
var $author$project$Config$Calibration$viewActionButtons = function (model) {
	var busy = _Utils_eq(model.ax, $krisajenkins$remotedata$RemoteData$Loading) || _Utils_eq(model.az, $krisajenkins$remotedata$RemoteData$Loading);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-secondary'),
						$elm$html$Html$Events$onClick($author$project$Config$Calibration$RunAnalyze),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-secondary'),
						$elm$html$Html$Events$onClick($author$project$Config$Calibration$RunDryRun),
						$elm$html$Html$Attributes$disabled(busy)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-primary'),
						$elm$html$Html$Events$onClick($author$project$Config$Calibration$SaveConfig),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.t, $author$project$Config$Calibration$Clean) || busy)
					]),
				_List_fromArray(
					[
...
var $author$project$Config$Calibration$viewMemberTau = function (m) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Config$Calibration$viewTopPair = function (pair) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							...
							6,
							$elm$core$String$fromFloat(pair.cG)))
					]))
			]));
};
var $author$project$Config$Calibration$viewAnalyzeResult = function (rd) {
	switch (rd.$) {
		case 0:
			return $elm$html$Html$text('');
		case 1:
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'δ: ' + ($elm$core$String$fromInt(r.cN) + ' pair(s) would collapse as near-dups')),
								r.cL ? A2(
								$elm$html$Html$span,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										' (sampled ' + ($elm$core$String$fromInt(r.cM) + ' of corpus)'))
									])) : $elm$html$Html$text('')
							])),
						$elm$core$List$isEmpty(r.bS) ? $elm$html$Html$text('') : A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								A2(
									...
									A2($elm$core$List$map, $author$project$Config$Calibration$viewTopPair, r.bS)))
							])),
						A2(
						$elm$html$Html$h3,
						_List_Nil,
						...
						A2(
							...
							A2($elm$core$List$map, $author$project$Config$Calibration$viewMemberTau, r.b1)))
					]));
	}
};
var $author$project$Config$Calibration$viewDryRunOutcome = function (o) {
	return A2(
		$elm$html$Html$tr,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('outcome-imported', o.bu === 'imported'),
						_Utils_Tuple2('outcome-error', o.bu === 'error')
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Config$Calibration$viewDryRunResult = function (rd) {
	switch (rd.$) {
		case 0:
			return $elm$html$Html$text('');
		case 1:
				...
				_List_fromArray(
					[
						...
						A2(
							...
							A2($elm$core$List$map, $author$project$Config$Calibration$viewDryRunOutcome, outcomes)))
					]));
	}
};
var $author$project$Config$Calibration$ResetForm = {$: 10};
var $elm$html$Html$fieldset = _VirtualDom_node('fieldset');
var $author$project$Config$Calibration$FieldChanged = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $author$project$Config$Calibration$knobRow = F6(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Config$Calibration$FieldChanged(setter))
						]),
					_List_Nil)
				]));
	});
var $author$project$Config$Calibration$viewKnobForm = function (model) {
	...
	var d = $author$project$Config$Calibration$currentDraft(model);
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A6(
						$author$project$Config$Calibration$knobRow,
						'Taste threshold (τ)',
						'0',
						'1',
						'0.01',
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Processing limits')
							])),
						A6(
						$author$project$Config$Calibration$knobRow,
						'Fetch max / tick',
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-secondary'),
						$elm$html$Html$Events$onClick($author$project$Config$Calibration$ResetForm)
					]),
				_List_fromArray(
					[
	...
	switch (_v0.$) {
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Config$Calibration$viewKnobForm(model),
						$author$project$Config$Calibration$viewActionButtons(model),
						$author$project$Config$Calibration$viewAnalyzeResult(model.ax),
						$author$project$Config$Calibration$viewDryRunResult(model.az)
					]));
	}
};
var $author$project$Config$Calibration$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$Config$Calibration$viewSavedConfig(model),
				$author$project$Config$Calibration$viewConfirmBanner(model)
			]));
};
var $author$project$Config$Flyer$SaveConfig = {$: 2};
var $author$project$Config$Flyer$viewActionButtons = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-primary'),
						$elm$html$Html$Events$onClick($author$project$Config$Flyer$SaveConfig),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.t, $author$project$Config$Flyer$Clean))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Save')
...
var $author$project$Config$Flyer$ResetForm = {$: 4};
var $author$project$Config$Flyer$currentDraft = function (model) {
	var _v0 = model.t;
	if (!_v0.$) {
		return $author$project$Config$Flyer$configToDraft(
			A2($krisajenkins$remotedata$RemoteData$withDefault, $author$project$Config$Flyer$defaultConfig, model.ah));
...
var $author$project$Config$Flyer$FieldChanged = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Config$Flyer$knobRow = F6(
	function (lbl, mn, mx, stp, val, setter) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(val),
							$elm$html$Html$Events$onInput(
							$author$project$Config$Flyer$FieldChanged(setter))
						]),
					_List_Nil)
				]));
	});
var $author$project$Config$Flyer$viewKnobForm = function (model) {
	var isDirty = function () {
		var _v0 = model.t;
		if (!_v0.$) {
			return false;
	...
	var d = $author$project$Config$Flyer$currentDraft(model);
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Flyer settings')
					])),
				A2(
				$elm$html$Html$fieldset,
				_List_Nil,
				_List_fromArray(
					[
						A6(
						$author$project$Config$Flyer$knobRow,
						'Min discount %',
						'0',
						'100',
						'1',
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-secondary'),
						$elm$html$Html$Events$onClick($author$project$Config$Flyer$ResetForm)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Reset')
...
var $author$project$Config$Flyer$viewContent = function (model) {
	var _v0 = model.ah;
	switch (_v0.$) {
		case 0:
			return $elm$html$Html$text('');
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Config$Flyer$viewKnobForm(model),
						$author$project$Config$Flyer$viewActionButtons(model)
					]));
	}
};
var $author$project$Config$Flyer$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Config — Flyer')
					])),
				$author$project$Config$Flyer$viewContent(model)
			]));
};
var $author$project$Config$Ranking$SaveConfig = {$: 2};
var $author$project$Config$Ranking$viewActionButtons = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-primary'),
						$elm$html$Html$Events$onClick($author$project$Config$Ranking$SaveConfig),
						$elm$html$Html$Attributes$disabled(
						_Utils_eq(model.t, $author$project$Config$Ranking$Clean))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Save')
...
var $author$project$Config$Ranking$ResetForm = {$: 4};
var $author$project$Config$Ranking$currentDraft = function (model) {
	var _v0 = model.t;
	if (!_v0.$) {
		return $author$project$Config$Ranking$configToDraft(
			A2($krisajenkins$remotedata$RemoteData$withDefault, $author$project$Config$Ranking$defaultConfig, model.ah));
...
var $author$project$Config$Ranking$FieldChanged = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Config$Ranking$knobRow = F6(
	function (lbl, mn, mx, stp, val, setter) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(val),
							$elm$html$Html$Events$onInput(
							$author$project$Config$Ranking$FieldChanged(setter))
						]),
					_List_Nil)
				]));
	});
var $author$project$Config$Ranking$viewKnobForm = function (model) {
	var isDirty = function () {
		var _v0 = model.t;
		if (!_v0.$) {
			return false;
	...
	var d = $author$project$Config$Ranking$currentDraft(model);
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('btn-secondary'),
						$elm$html$Html$Events$onClick($author$project$Config$Ranking$ResetForm)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Reset')
...
var $author$project$Config$Ranking$viewContent = function (model) {
	var _v0 = model.ah;
	switch (_v0.$) {
		case 0:
			return $elm$html$Html$text('');
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Config$Ranking$viewKnobForm(model),
						$author$project$Config$Ranking$viewActionButtons(model)
					]));
	}
};
var $author$project$Config$Ranking$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Config — Ranking Weights')
					])),
				$author$project$Config$Ranking$viewContent(model)
			]));
};
var $author$project$Config$TableEditor$SubmitAdd = {$: 2};
var $author$project$Config$TableEditor$TestDraft = {$: 1};
var $author$project$Config$TableEditor$addLabel = function (action) {
...
var $author$project$Config$TableEditor$draftTestUrl = function (model) {
	return A2(
		$elm$core$Maybe$map,
		$author$project$Config$TableEditor$draftValue(model.ae),
		model.N.bb);
};
var $author$project$Config$TableEditor$DraftChanged = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Config$TableEditor$viewField = F2(
	function (draft, field) {
		return A2(
			$elm$html$Html$label,
			_List_Nil,
					...
					_List_fromArray(
						[
							...
							A2(
								$elm$core$Maybe$withDefault,
								'',
								A2($elm$core$Dict$get, field.X, draft))),
							...
							$elm$html$Html$Events$onInput(
							$author$project$Config$TableEditor$DraftChanged(field.X))
						]),
					_List_Nil)
				]));
	});
var $author$project$Config$TableEditor$TestFeed = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var $author$project$Config$TableEditor$isTesting = F2(
	function (test, target) {
		if ((!test.$) && (test.a.b.$ === 1)) {
			var _v1 = test.a;
			var t = _v1.a;
			var _v2 = _v1.b;
			return _Utils_eq(t, target);
		} else {
			return false;
		}
	});
var $author$project$Config$TableEditor$testButtonLabel = F2(
	function (test, target) {
		return A2($author$project$Config$TableEditor$isTesting, test, target) ? 'Testing…' : 'Test';
	});
var $author$project$Config$TableEditor$viewTestButton = F3(
	function (model, target, maybeUrl) {
		if (!maybeUrl.$) {
			var url = maybeUrl.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class('btn-secondary'),
							$elm$html$Html$Events$onClick(
							A2($author$project$Config$TableEditor$TestFeed, target, url)),
							$elm$html$Html$Attributes$disabled(
							A2($author$project$Config$TableEditor$isTesting, model.aE, target))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($author$project$Config$TableEditor$testButtonLabel, model.aE, target))
						]))
				]);
		} else {
			return _List_Nil;
...
var $author$project$Config$TableEditor$viewAddForm = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('card'),
				$elm$html$Html$Events$onSubmit($author$project$Config$TableEditor$SubmitAdd)
			]),
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$Config$TableEditor$viewField(model.ae),
					model.N.aV)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('btn-primary'),
								$elm$html$Html$Attributes$disabled(
								(!$author$project$Config$TableEditor$canAdd(model)) || $author$project$Config$TableEditor$isBusy(model.y))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Config$TableEditor$addLabel(model.y))
							])),
					A3(
						$author$project$Config$TableEditor$viewTestButton,
						model,
						$author$project$Config$TableEditor$TestDraft,
						$author$project$Config$TableEditor$draftTestUrl(model))))
			]));
};
var $author$project$Config$TableEditor$httpError = function (error) {
	switch (error.$) {
		case 0:
			var url = error.a;
			return 'bad URL ' + url;
		...
		case 3:
			switch (error.a) {
				case 403:
					return 'forbidden (403) — your Cloudflare Access session is missing or expired';
				case 400:
					return 'rejected (400) — check the field values';
				default:
					var status = error.a;
					return 'HTTP ' + $elm$core$String$fromInt(status);
			}
...
var $author$project$Config$TableEditor$operationLabel = function (op) {
	if (!op.$) {
		return 'Add';
	} else {
		var key = op.a;
...
var $author$project$Config$TableEditor$viewFailure = function (action) {
	if (action.$ === 2) {
		var op = action.a;
		var err = action.b;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('card error')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Config$TableEditor$operationLabel(op) + (' failed: ' + $author$project$Config$TableEditor$httpError(err)))
						]))
				]));
	} else {
		return $elm$html$Html$text('');
...
var $author$project$Config$TableEditor$RemoveRow = function (a) {
	return {$: 4, a: a};
};
var $author$project$Config$TableEditor$TestRow = function (a) {
	return {$: 0, a: a};
};
var $author$project$Config$TableEditor$removeLabel = F2(
	function (action, key) {
		if ((action.$ === 1) && (action.a.$ === 1)) {
			var k = action.a.a;
			return _Utils_eq(k, key) ? 'Removing…' : 'Remove';
		} else {
			return 'Remove';
		}
	});
...
var $author$project$Config$TableEditor$rowKey = F2(
	function (config, row) {
		return $author$project$Data$Table$renderCell(
			A2($elm$core$Dict$get, config.a5, row));
	});
var $author$project$Config$TableEditor$viewRow = F3(
	function (model, columns, row) {
		var rowTestUrl = A2(
			$elm$core$Maybe$map,
			function (col) {
				return $author$project$Data$Table$renderCell(
					A2($elm$core$Dict$get, col, row));
			},
			model.N.bb);
		var key = A2($author$project$Config$TableEditor$rowKey, model.N, row);
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_Utils_ap(
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('btn-secondary'),
										$elm$html$Html$Events$onClick(
										$author$project$Config$TableEditor$RemoveRow(key)),
										$elm$html$Html$Attributes$disabled(
										$author$project$Config$TableEditor$isBusy(model.y))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($author$project$Config$TableEditor$removeLabel, model.y, key))
									])),
							A3(
								$author$project$Config$TableEditor$viewTestButton,
								model,
								$author$project$Config$TableEditor$TestRow(key),
								rowTestUrl)))
					])));
	});
var $author$project$Config$TableEditor$viewRows = function (model) {
	var _v0 = model.av;
	switch (_v0.$) {
		case 0:
			return $elm$html$Html$text('');
		...
		case 2:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Could not load: ' + $author$project$Config$TableEditor$httpError(err))
					]));
		default:
			var page = _v0.a;
			return $elm$core$List$isEmpty(page.av) ? A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('muted')
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									A2($author$project$Config$TableEditor$viewRow, model, page.cE),
									page.av))
							]))
					]));
	}
};
var $author$project$Config$TableEditor$testTargetLabel = function (target) {
	if (!target.$) {
		var key = target.a;
		return key;
	} else {
...
var $author$project$Config$TableEditor$statusSuffix = function (status) {
	if (!status.$) {
		var code = status.a;
...
var $author$project$Config$TableEditor$viewSample = function (sample) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				sample.bI + (' — ' + (sample.bu + $author$project$Config$TableEditor$statusSuffix(sample.bB))))
			]));
};
var $author$project$Config$TableEditor$viewVerdict = function (verdict) {
	var total = $elm$core$List$length(verdict.bz);
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						verdict.bo.dB ? ('Feed reachable — ' + ($elm$core$String$fromInt(verdict.bo.de) + ' items')) : ('Feed unreachable' + $author$project$Config$TableEditor$statusSuffix(verdict.bo.bB)))
					])),
				(!total) ? A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('No entry pages sampled.')
					])) : A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(parsedCount) + ('/' + ($elm$core$String$fromInt(total) + ' sampled pages parsed as recipes')))
							])),
						A2(
						$elm$html$Html$ul,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Config$TableEditor$viewSample, verdict.bz))
					]))
			]));
};
var $author$project$Config$TableEditor$viewTest = function (model) {
	var _v0 = model.aE;
	if (_v0.$ === 1) {
		return $elm$html$Html$text('');
	} else {
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									'Feed test — ' + $author$project$Config$TableEditor$testTargetLabel(target))
								]))
						])),
					function () {
					switch (data.$) {
						...
						case 1:
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Testing from the edge…')
									]));
						case 2:
							var err = data.a;
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Test failed: ' + $author$project$Config$TableEditor$httpError(err))
									]));
						default:
							var verdict = data.a;
							return $author$project$Config$TableEditor$viewVerdict(verdict);
					}
				}()
				]));
	}
};
var $author$project$Config$TableEditor$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.N.bd)
					])),
				$author$project$Config$TableEditor$viewAddForm(model),
				$author$project$Config$TableEditor$viewFailure(model.y),
				$author$project$Config$TableEditor$viewTest(model),
				$author$project$Config$TableEditor$viewRows(model)
			]));
};
var $author$project$Config$viewSection = function (section) {
	switch (section.$) {
		case 0:
			var m = section.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Config$CalibrationMsg,
				$author$project$Config$Calibration$view(m));
		case 1:
			var m = section.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Config$RankingMsg,
				$author$project$Config$Ranking$view(m));
		case 2:
			var m = section.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Config$FlyerMsg,
				$author$project$Config$Flyer$view(m));
		default:
			var m = section.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Config$EditorMsg,
				$author$project$Config$TableEditor$view(m));
	}
};
var $author$project$Config$tabs = _List_fromArray(
	[
		_Utils_Tuple2('Calibration', 0),
		_Utils_Tuple2('Ranking', 1),
		_Utils_Tuple2('Flyer', 2),
		_Utils_Tuple2('Aliases', 3),
		_Utils_Tuple2('Flyer terms', 4),
		_Utils_Tuple2('Feeds', 5),
		_Utils_Tuple2('Senders', 6),
		_Utils_Tuple2('Members', 7)
	]);
var $author$project$Config$viewTab = F2(
	function (active, _v0) {
		var label = _v0.a;
		var configRoute = _v0.b;
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'active',
							_Utils_eq(active, configRoute))
						])),
					$author$project$Route$href(
					$author$project$Route$Config(configRoute))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$Config$viewSubnav = function (active) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			$author$project$Config$viewTab(active),
			$author$project$Config$tabs));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Config$viewSection(model.bA)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Data$Table$viewTab(model.aT),
					model.a9)),
				$author$project$Data$Table$viewPage(model.aO)
			]));
};
...
var $author$project$Data$Corpus$viewEntry = F2(
	function (prefix, entry) {
		var full = _Utils_ap(prefix, entry.bt);
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
...
var $dillonkearns$elm_markdown$Markdown$Renderer$defaultHtmlRenderer = {
	bL: $elm$html$Html$blockquote(_List_Nil),
	bN: function (_v0) {
		var body = _v0.bM;
		var language = _v0.eC;
	...
	bY: A2($elm$html$Html$br, _List_Nil, _List_Nil),
	bZ: function (_v3) {
		var level = _v3.dj;
		var children = _v3.cB;
		switch (level) {
	...
	ew: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
	ex: function (imageInfo) {
		var _v5 = imageInfo.bd;
		if (!_v5.$) {
			var title = _v5.a;
			return A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(imageInfo.dT),
						$elm$html$Html$Attributes$alt(imageInfo.cw),
		...
		function (link, content) {
			...
			if (!_v6.$) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(link.cP),
							$elm$html$Html$Attributes$title(title)
						]),
					content);
			} else {
	...
	ci: function (children) {
		return A2($elm$html$Html$strong, _List_Nil, children);
	},
	fc: $elm$html$Html$table(_List_Nil),
	ck: $elm$html$Html$tbody(_List_Nil),
	cl: function (maybeAlignment) {
		var attrs = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
	...
	cm: $elm$html$Html$thead(_List_Nil),
	cn: function (maybeAlignment) {
		var attrs = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
	...
	bD: $elm$html$Html$tr(_List_Nil),
	m: $elm$html$Html$text,
	cp: A2($elm$html$Html$hr, _List_Nil, _List_Nil),
	cq: function (items) {
		return A2(
			$elm$html$Html$ul,
			_List_Nil,
...
var $author$project$Markdown$safeUrl = function (url) {
	var trimmed = $elm$core$String$trim(url);
	var lower = $elm$core$String$toLower(trimmed);
	return (A2($elm$core$String$startsWith, 'http://', lower) || (A2($elm$core$String$startsWith, 'https://', lower) || (A2($elm$core$String$startsWith, '/', trimmed) || A2($elm$core$String$startsWith, '#', trimmed)))) ? trimmed : '#';
};
var $author$project$Markdown$renderImage = function (image) {
	var _v0 = image.bd;
	if (!_v0.$) {
		var t = _v0.a;
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Markdown$safeUrl(image.dT)),
					$elm$html$Html$Attributes$alt(image.cw),
...
var $author$project$Markdown$renderLink = F2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Markdown$safeUrl(link.cP)),
						$elm$html$Html$Attributes$title(t)
					]),
				children);
		} else {
...
var $author$project$Markdown$hardened = function () {
	var _default = $dillonkearns$elm_markdown$Markdown$Renderer$defaultHtmlRenderer;
	return _Utils_update(
		_default,
		{
			ew: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
			ex: $author$project$Markdown$renderImage,
			eF: $author$project$Markdown$renderLink
		});
}();
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.dT);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.e, offset) < 0,
					0,
					{cC: col, h: s0.h, j: s0.j, e: offset, e7: row, dT: s0.dT});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.e, s.e7, s.cC, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cC: col, ej: contextStack, e_: problem, e7: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.e7, s.cC, x, s.h));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.e, s.e7, s.cC, s.dT);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cC: newCol, h: s.h, j: s.j, e: newOffset, e7: newRow, dT: s.dT});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.e, s1.e, s0.dT),
						a),
					s1);
			}
		};
...
var $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.e7) + ('\n' + $dillonkearns$elm_markdown$Markdown$Parser$problemToString(deadEnd.e_)));
};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.e, s.dT);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{cC: 1, h: s.h, j: s.j, e: s.e + 1, e7: s.e7 + 1, dT: s.dT}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cC: s.cC + 1, h: s.h, j: s.j, e: newOffset, e7: s.e7, dT: s.dT}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.e, s.e7, s.cC, s.dT);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.dT) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.e, adjustedOffset) < 0,
			0,
			{cC: newCol, h: s.h, j: s.j, e: adjustedOffset, e7: newRow, dT: s.dT});
	};
};
...
var $dillonkearns$elm_markdown$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {bM: body, eA: intended, eG: marker, eY: order};
	});
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.eA, item.eG, item.eY, _List_Nil, item.bM);
		},
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.m);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.m);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
		...
		case 4:
			...
			return A3(
				...
				url,
				maybeTitle,
				$dillonkearns$elm_markdown$Markdown$InlineParser$matchesToInlines(match.u));
		case 5:
			var _v4 = _v1.a;
			var url = _v4.a;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {i: childMatch.i - parentMatch.w, u: childMatch.u, k: childMatch.k - parentMatch.w, m: childMatch.m, L: childMatch.L - parentMatch.w, w: childMatch.w - parentMatch.w, o: childMatch.o};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$organizeChildren = function (_v4) {
	...
	return {
		i: match.i,
		u: $dillonkearns$elm_markdown$Markdown$InlineParser$organizeMatches(match.u),
		k: match.k,
		m: match.m,
		L: match.L,
		w: match.w,
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {d: index, a1: match, eT: number, cj: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		u: _List_Nil,
		k: 0,
		m: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		L: 0,
		w: 0,
		o: $dillonkearns$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			i: matchModel.i,
			u: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.m, _List_Nil, matchModel.u),
			k: matchModel.k,
			m: matchModel.m,
			L: matchModel.L,
			w: matchModel.w,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, b$: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{d: (regMatch.d + backslashesLength) - 1, b$: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							d: regMatch.d,
							b$: $elm$core$String$length(regMatch.a1),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{d: regMatch.d + backslashesLength, b$: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{d: (regMatch.d + backslashesLength) - 1, b$: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, b$: 1, f: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{d: index, b$: 2, f: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						d: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{d: regMatch.d + backslashesLength, b$: length, f: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.a1,
				$elm$url$Url$percentDecode(match.a1));
		}));
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.m) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				o: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.m,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.m)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, references, maybeRegexMatch) {
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.m : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.m,
		...
		if (_v0.$ === 1) {
			...
			var regexMatchLength = function () {
				if (!maybeRegexMatch.$) {
					var match = maybeRegexMatch.a.a1;
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{i: matchModel.i + regexMatchLength, o: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						i: matchModel.i + $elm$core$String$length(regexMatch.a1),
						o: function () {
							var _v5 = matchModel.o;
							if (_v5.$ === 5) {
								return $dillonkearns$elm_markdown$Markdown$InlineParser$ImageType;
							} else {
								return $dillonkearns$elm_markdown$Markdown$InlineParser$LinkType;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.m) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				o: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.m,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.m)))
			})) : $elm$core$Result$Err(match);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cC: 1, h: _List_Nil, j: 1, e: 0, e7: 1, dT: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {c7: htmlTag, b$: endOffset - startOffset};
							})),
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.bq, open.bw) || _Utils_eq(close.bq, close.bw)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.b$ + openToken.b$))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.b$)) && (!A2($elm$core$Basics$modBy, 3, openToken.b$)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 9) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.b$ - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.b$);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 9) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.b$ - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.b$);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {i: token.d + token.b$, u: _List_Nil, k: token.d, m: '', L: 0, w: 0, o: type_};
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{d: openToken.d + 1, b$: openToken.b$ - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v27.$ === 7) {
					var _char = _v27.a;
					var leftFringeRank = _v27.b.bq;
					var rightFringeRank = _v27.b.bw;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var updt = (!remainLength) ? {bk: closeToken, a4: openToken, bv: remainTokens, bG: tokensTail} : ((remainLength > 0) ? {
			bk: closeToken,
			a4: _Utils_update(
				openToken,
				{d: openToken.d + remainLength, b$: closeToken.b$}),
			bv: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			bG: A2(
				...
				_Utils_update(
					closeToken,
					{d: closeToken.d + openToken.b$, b$: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.a4.b$),
			updt.a4,
			updt.bk,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.bG, match, updt.bv);
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		...
		return {i: end, u: matches, k: start, m: text, L: textEnd, w: textStart, o: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {bh: alignment, Z: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {bi: '`', Y: 0, bF: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.bF)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
			...
			A2(
				...
				builtTokens,
				$elm$parser$Parser$Advanced$chompWhile(
					$elm$core$Basics$eq(fenceCharacter.bi))));
	});
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {bi: '~', Y: 1, bF: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {bj: character, b_: indent, b$: length};
					})),
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.b$, fence.bj))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
	...
	function (fence) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$dillonkearns$elm_markdown$Markdown$CodeBlock$infoString(fence.bj),
					$dillonkearns$elm_markdown$Helpers$lineEndOrEnd)),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.e, s.e7, s.cC, s.dT);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {cC: col, h: context, e7: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {cC: s.cC, h: newContext, j: s.j, e: s.e, e7: s.e7, dT: s.dT};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.e7, s0.cC, context),
						s0.h),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		F2(
			function (delimiterText, revDelimiterColumns) {
				return A2(
					...
					{
						dA: delimiterText,
						d2: $elm$core$String$trim(delimiterText)
					},
					A2(
						$elm$core$List$map,
		...
		function (listmarker, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {bM: body, eG: listmarker, p: $elm$core$Maybe$Nothing};
				default:
					return {bM: '', eG: listmarker, p: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												bM: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.bM, block1.bM),
					...
					case 3:
						...
						switch (newRawBlock.$) {
							case 3:
								...
								if (_Utils_eq(openListItem2.eG, openListItem1.eG)) {
									var _v59 = A2(
										$elm$parser$Parser$Advanced$run,
										$dillonkearns$elm_markdown$Markdown$Parser$cyclic$rawBlockParser(),
										openListItem2.bM);
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														bM: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.bM, body1)
													})),
											rest)
									});
							default:
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.p, item.bM);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{bM: codeBlockBody, eC: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.dA)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	bM: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '', openListItem.bM, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.bM) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderHelperSingle = function (renderer) {
	return function (block) {
		switch (block.$) {
							...
							return renderer.bZ(
								{
									cB: children,
									dj: level,
									e$: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.cp));
			case 3:
								...
								renderer.bD(
									A2(
										...
										function (_v10) {
											...
											var item = _v10.b;
											return A2(renderer.cn, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.ex(
							{
								cw: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(children),
								dT: src,
								bd: title
							})));
			case 7:
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.bY));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $author$project$Markdown$render = function (raw) {
	var _v0 = A2(
		$elm$core$Result$andThen,
		A2(
			$elm$core$Basics$composeR,
			$dillonkearns$elm_markdown$Markdown$Renderer$render($author$project$Markdown$hardened),
			$elm$core$Result$mapError(
	...
	if (!_v0.$) {
		var blocks = _v0.a;
		return A2($elm$html$Html$div, _List_Nil, blocks);
	} else {
		return A2(
			$elm$html$Html$pre,
			_List_Nil,
					...
					switch (object.$) {
						...
						default:
							...
							return $elm$core$String$isEmpty(markdown) ? A2(
								...
								_List_fromArray(
									[
										$author$project$Markdown$render(markdown)
									]));
					}
				}()
				]));
...
var $author$project$Data$Corpus$viewGuidance = function (model) {
	...
	if (!_v0.$) {
		...
		return A2($author$project$Data$Corpus$viewListing, model.a6, model.a0);
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Data$Table$view(model.a9)),
...
var $author$project$Data$Member$viewMember = function (detail) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Data$Member$valueSection, 'Profile', detail.cd),
				A2($author$project$Data$Member$listSection, 'Pantry', detail.b9),
				A2($author$project$Data$Member$listSection, 'Meal plan', detail.b0),
				A2($author$project$Data$Member$listSection, 'Grocery list', detail.bX),
				A2($author$project$Data$Member$listSection, 'Overlay (favorites / rejects)', detail.b8),
				A2($author$project$Data$Member$listSection, 'Cooking log', detail.bP),
				A2($author$project$Data$Member$listSection, 'Recipe notes (authored)', detail.ce),
				A2($author$project$Data$Member$listSection, 'Store notes (authored)', detail.bC)
			]));
};
...
var $author$project$Data$Member$view = function (model) {
	...
	if (!_v0.$) {
		...
		return $author$project$Data$Member$viewMembers(model.aN);
	}
};
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							detail.c3 ? 'embedding: present' : 'embedding: not yet generated')
						]))
				]));
	} else {
		return $elm$html$Html$text('');
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						d.cX ? 'favorite' : (d.dC ? 'reject' : 'neutral'))
					]))
			]));
};
...
var $author$project$Data$Recipe$viewRenderedBody = function (body) {
	if (!body.$) {
		var markdown = body.a;
		return $elm$core$String$isEmpty(
			$elm$core$String$trim(markdown)) ? $elm$html$Html$text('') : A2(
			$author$project$Data$Recipe$section,
			'Rendered body',
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Data$Recipe$viewTier(detail.d$)),
				$author$project$Data$Recipe$viewDescription(detail),
				$author$project$Data$Recipe$viewDispositions(detail.cR),
				A2(
				$author$project$Data$Recipe$section,
				'Cross-tenant notes',
				$author$project$Data$Recipe$viewJsonList(detail.dq)),
				$author$project$Data$Recipe$viewRenderedBody(detail.bM),
				A2(
				$author$project$Data$Recipe$section,
				'R2 source (recipes/<slug>.md)',
				_List_fromArray(
					[
						$author$project$Data$Recipe$viewSource(detail.dR)
					])),
				A2(
				$author$project$Data$Recipe$section,
				...
				_List_fromArray(
					[
						$author$project$Data$Recipe$viewMaybeJson(detail.dx)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(selected.a8)
					])),
				function () {
				var _v0 = selected.bl;
				switch (_v0.$) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/admin/data/recipes/' + entry.a8)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(entry.a8)
							]))
					])),
				A2(
				$elm$html$Html$td,
				...
				_List_fromArray(
					[
						$author$project$Data$Recipe$statusBadge(entry.bB)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$core$Maybe$withDefault, '—', entry.bd))
					]))
			]));
};
...
var $author$project$Data$Recipe$view = function (model) {
	...
	if (!_v0.$) {
		...
		return $author$project$Data$Recipe$viewList(model.br);
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Data$viewSection(model.bA)
			]));
};
				...
				switch (_v0.$) {
					...
					case 3:
						...
						return A2(
							...
							A2(
								$elm$core$List$map,
								$author$project$Dev$ToolConsole$viewToolItem(session.aP),
								tools));
					default:
						return $elm$html$Html$text('');
				}
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2('error', invocation.dc)
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($elm$json$Json$Encode$encode, 2, invocation.dI))
								]))
						]));
		}
	}
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($elm$core$Maybe$withDefault, '', session.aP))
								])),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Dev$ToolConsole$needsConfirm(session.at) ? A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('muted small')
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$json$Json$Encode$encode, 2, t.a7))
						]))
				]));
	} else {
		return $elm$html$Html$text('');
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Dev$ToolConsole$viewResult(session.ac)
				]));
	}
};
...
var $author$project$Dev$ToolConsole$viewPersonaBar = function (model) {
	var current = function () {
		if (model.$ === 1) {
			var session = model.a;
			return $elm$core$Maybe$Just(session.at);
		} else {
			return $elm$core$Maybe$Nothing;
		}
	}();
...
var $author$project$Logs$entryTitle = function (entry) {
	var _v0 = _Utils_Tuple2(entry.bd, entry.bI);
	if (!_v0.a.$) {
		var t = _v0.a.a;
		return t;
	} else {
...
var $author$project$Logs$outcomeClassWord = function (outcome) {
	switch (outcome.$) {
		...
		case 6:
			return _Utils_Tuple2('fail', 'failed');
		default:
			var raw = outcome.a;
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					'outcome',
					$author$project$Logs$outcomeLabel(entry.bu))
				]),
			_Utils_ap(
				A2($author$project$Logs$maybeRow, 'url', entry.bI),
				_Utils_ap(
					A2($author$project$Logs$maybeRow, 'source', entry.dR),
					_Utils_ap(
						A2($author$project$Logs$maybeRow, 'imported as', entry.a8),
						_Utils_ap(
							A2($author$project$Logs$maybeRow, 'at', entry.bQ),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$div,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(
													A2($elm$json$Json$Encode$encode, 2, entry.bl))
												]))
										]))
								])))))));
};
...
var $author$project$Logs$DeleteRow = function (a) {
	return {$: 5, a: a};
};
var $author$project$Logs$OpenEntry = function (a) {
	return {$: 1, a: a};
};
var $author$project$Logs$RetryRow = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Logs$hasDetail = function (entry) {
	return (!_Utils_eq(entry.a8, $elm$core$Maybe$Nothing)) || (!$author$project$Logs$isEmptyDetail(entry.bl));
};
...
var $author$project$Logs$isRetryable = function (outcome) {
	return _Utils_eq(outcome, $author$project$Logs$Errored) || _Utils_eq(outcome, $author$project$Logs$Failed);
};
var $author$project$Logs$isRowBusy = F2(
...
var $author$project$Logs$viewEntryRow = F2(
	function (rowAction, entry) {
		var busy = $author$project$Logs$isAnyBusy(rowAction);
		var attrs = A2(
			$elm$core$List$cons,
			$elm$html$Html$Attributes$classList(
				_List_fromArray(
		...
		var _v0 = $author$project$Logs$outcomeClassWord(entry.bu);
		var cls = _v0.a;
		var word = _v0.b;
		return A2(
			$elm$html$Html$li,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', entry.dR))
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '', entry.bQ))
						])),
					$author$project$Logs$isRetryable(entry.bu) ? A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('entry-row-actions')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('link small'),
									$elm$html$Html$Attributes$disabled(busy),
									$elm$html$Html$Events$onClick(
									$author$project$Logs$RetryRow(entry.aL))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($author$project$Logs$isRowBusy, rowAction, entry.aL) ? 'Retrying…' : 'Retry')
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$disabled(busy),
									$elm$html$Html$Events$onClick(
									$author$project$Logs$DeleteRow(entry.aL))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
									A2($author$project$Logs$isRowBusy, rowAction, entry.aL) ? 'Deleting…' : 'Delete')
								]))
...
var $author$project$Logs$viewLoaded = F2(
	function (discovery, rowAction) {
		switch (discovery.$) {
			case 0:
				return A2(
					$elm$html$Html$p,
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									$author$project$Logs$viewEntryRow(rowAction),
									entries)),
...
var $author$project$Logs$viewRowActionBanner = function (rowAction) {
	if (rowAction.$ === 1) {
		return $elm$html$Html$text('');
	} else {
		switch (rowAction.a.$) {
			...
			default:
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							((kind === 'retry') ? 'Retry' : 'Delete') + (' failed: ' + $author$project$Logs$httpError(err)))
						]));
		}
	}
};
var $author$project$Logs$viewSource = F3(
	function (selected, discovery, rowAction) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('log-actions')
								]),
							_List_fromArray(
								[
									A2(
					...
					$author$project$Logs$viewRowActionBanner(rowAction),
					A2($author$project$Logs$viewLoaded, discovery, rowAction)
				]));
	});
...
var $author$project$Logs$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Logs$viewSubmenu(model.aP),
				A3($author$project$Logs$viewSource, model.aP, model.H, model.W)
			]));
};
...
var $author$project$Status$viewAdminRow = function (posture) {
	...
	var detail = ((gs === 1) && posture.cT) ? _List_fromArray(
		[
...
var $author$project$Status$viewAiQuotaWarning = function (exhausted) {
	return exhausted ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Workers AI quota exhausted. ')
					])),
				$elm$html$Html$text('The daily free allocation of 10,000 neurons is used up (error 4006), so the recipe-classify, recipe-embed, and discovery cron jobs cannot run their AI steps. They resume at the next daily reset — or upgrade to the Cloudflare Workers Paid plan to remove the cap.')
			])) : $elm$html$Html$text('');
};
...
var $author$project$Status$viewJobRow = F3(
	function (zone, now, job) {
		var _v0 = $author$project$Status$jobStateClassWord(job.dU);
		var cls = _v0.a;
		var word = _v0.b;
		var _v1 = function () {
			var _v2 = job.di;
		...
		return A6(
			...
			age,
			ageTitle,
			A2($author$project$Status$viewSummary, zone, job.dY));
	});
var $author$project$Status$viewPayload = F2(
	function (zone, payload) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Status$viewExposedWarning(payload.bK),
					$author$project$Status$viewAiQuotaWarning(payload.cu),
					$author$project$Status$viewHeadline(payload.ds),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
					...
					_Utils_ap(
						A2(
							$elm$core$List$map,
							A2($author$project$Status$viewJobRow, zone, payload.c$),
							payload.df),
						_List_fromArray(
							[
								$author$project$Status$viewD1Row(payload.cI),
								$author$project$Status$viewAdminRow(payload.bK)
							])))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Status$viewBody, model.bJ, model.a_)
			]));
};
	...
	switch (_v0.$) {
		...
		case 2:
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$Main$viewDevSubnav(model.bg),
						A2(
						$elm$html$Html$section,
						_List_fromArray(
							[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$wrapClass(model.ag))
					]),
				_List_fromArray(
					[
						A2(
						...
						$author$project$Main$viewNav(model.ag),
						$author$project$Main$viewPage(model)
					]))
			]),
		bd: 'grocery-agent admin'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		ez: $author$project$Main$init,
		eU: $author$project$Main$UrlChanged,
		eV: $author$project$Main$LinkClicked,
		fb: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fh: $author$project$Main$update,
		fi: $author$project$Main$view
	});
