...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/constants.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/utils.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/context.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/context.js
var globalContexts = [];
var alsProbed = false;
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/intrinsic-element/common.js
var deDupeKeyMap = {
  title: [],
  script: ["src"],
  style: ["data-href"],
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/children.js
var toArray = (children) => Array.isArray(children) ? children : [children];

// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/utils.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/render.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/hooks/index.js
var STASH_SATE = 0;
var STASH_EFFECT = 1;
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/intrinsic-element/components.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/hooks/index.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/jsx/dom/jsx-dev-runtime.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/utils/cookie.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/client/utils.js
...
// ../../../root/.cache/aube/virtual-store/hono@4.12.27-870419e35ee7f198/node_modules/hono/dist/client/client.js
...
// src/admin/logs-shared.ts
function outcomeClassWord(outcome) {
  switch (outcome) {
    case "imported":
      return ["ok", "imported"];
    case "duplicate":
...
function DetailDialog({ entry, onClose }) {
  ...
  return /* @__PURE__ */ jsxDEV("div", { class: "dialog-backdrop", onClick: onClose, children: /* @__PURE__ */ jsxDEV("div", { class: "dialog", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxDEV("div", { class: "dialog-head", children: [
      /* @__PURE__ */ jsxDEV("h2", { children: entryTitle(entry) }),
      /* @__PURE__ */ jsxDEV("button", { class: "link", onClick: onClose, children: "Close" })
    ] }),
    /* @__PURE__ */ jsxDEV("div", { class: "dialog-body", children: [
      rows.filter(([, v]) => v != null && v !== "").map(([k, v]) => /* @__PURE__ */ jsxDEV("div", { class: "row", children: [
        /* @__PURE__ */ jsxDEV("span", { class: "k", children: k }),
        /* @__PURE__ */ jsxDEV("span", { class: "v", children: v })
      ] })),
      /* @__PURE__ */ jsxDEV("pre", { class: "detail-blob", children: JSON.stringify(entry.detail, null, 2) })
    ] })
  ] }) });
}
function LogsIsland({ entries }) {
  ...
  return /* @__PURE__ */ jsxDEV("div", { children: [
    /* @__PURE__ */ jsxDEV("div", { class: "log-head", children: [
      /* @__PURE__ */ jsxDEV("h2", { children: "Discovery" }),
      /* @__PURE__ */ jsxDEV("div", { class: "log-actions", children: /* @__PURE__ */ jsxDEV("button", { class: "link", disabled: busy, onClick: () => location.reload(), children: "Refresh" }) })
    ] }),
    action != null && action.kind === "failed" ? /* @__PURE__ */ jsxDEV("div", { class: "error", children: [
      action.action === "retry" ? "Retry" : "Delete",
      " failed: ",
      action.error
    ] }) : null,
    entries.length === 0 ? /* @__PURE__ */ jsxDEV("p", { class: "muted", children: "No discovery activity yet." }) : /* @__PURE__ */ jsxDEV("ul", { class: "entry-list", children: entries.map((e) => {
      ...
      return /* @__PURE__ */ jsxDEV(
        "li",
        {
          ...
          onClick: openable ? () => setDialog(e) : void 0,
          children: [
            /* @__PURE__ */ jsxDEV("span", { class: `entry-outcome ${cls}`, children: word }),
            /* @__PURE__ */ jsxDEV("span", { class: "entry-title", children: entryTitle(e) }),
            /* @__PURE__ */ jsxDEV("span", { class: "entry-source muted small", children: e.source ?? "" }),
            /* @__PURE__ */ jsxDEV("span", { class: "entry-time muted small", children: e.created_at ?? "" }),
            retryable ? /* @__PURE__ */ jsxDEV("span", { class: "log-actions", children: [
              /* @__PURE__ */ jsxDEV("button", { class: "link", disabled: busy, onClick: () => retry(e.id), children: action != null && action.kind === "retrying" && action.id === e.id ? "Retrying\u2026" : "Retry" }),
              /* @__PURE__ */ jsxDEV("button", { class: "danger", disabled: busy, onClick: () => del(e.id), children: action != null && action.kind === "deleting" && action.id === e.id ? "Deleting\u2026" : "Delete" })
            ] }) : openable ? /* @__PURE__ */ jsxDEV("span", { class: "entry-more", children: "details \u2192" }) : null
          ]
        },
        e.id
      );
    }) }),
    dialog != null ? /* @__PURE__ */ jsxDEV(DetailDialog, { entry: dialog, onClose: () => setDialog(null) }) : null
  ] });
}
var host = document.getElementById("logs-island");
var propsEl = document.getElementById("logs-props");
if (host && propsEl) {
  const props = JSON.parse(propsEl.textContent ?? "{}");
  host.replaceChildren();
  render(/* @__PURE__ */ jsxDEV(LogsIsland, { entries: props.entries }), host);
}
