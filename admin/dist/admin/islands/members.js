...
function MembersIsland(initial) {
  ...
  return /* @__PURE__ */ jsxDEV("div", { children: [
    ...
    /* @__PURE__ */ jsxDEV("table", { children: [
      /* @__PURE__ */ jsxDEV("thead", { children: /* @__PURE__ */ jsxDEV("tr", { children: [
        /* @__PURE__ */ jsxDEV("th", { children: "member" }),
        /* @__PURE__ */ jsxDEV("th", {})
      ] }) }),
      /* @__PURE__ */ jsxDEV("tbody", { children: members.map((m) => /* @__PURE__ */ jsxDEV("tr", { children: [
    ...
    /* @__PURE__ */ jsxDEV("form", { class: "form-actions", onSubmit: doOnboard, children: [
      /* @__PURE__ */ jsxDEV(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxDEV("button", { type: "submit", disabled: busy, children: "onboard" })
    ] })
  ] });
}
var host = document.getElementById("members-island");
var propsEl = document.getElementById("members-props");
if (host && propsEl) {
  const props = JSON.parse(propsEl.textContent ?? "{}");
  host.replaceChildren();
  render(/* @__PURE__ */ jsxDEV(MembersIsland, { members: props.members }), host);
}
