...
2. Clean up and classify into full frontmatter (protein, cuisine, style, tags, dietary, `ingredients_key`, `meal_preppable`, `season`, `requires_equipment`, etc.) and assemble the markdown body with `## Ingredients` and `## Instructions`.
